...
def unique_extensions(some_spisok, some_elements_dict):
    ...
    print(f'extentions: {list(extention)}\n')    


elements_dict = {} # пустой словарь
print('Have a next ')
unique_extensions(spisok, elements_dict)
...
print('Have next unknown ')
unique_extensions(empty_list_unknown, unknown_elements_dict)



# os.path.isfile(path+'\\' + i) проверяет является ли элемент фаойлом

#  C:/python/goit-python/lesson4/rekursia_files4.py C:/Users/Lenovo/Desktop/ОАК
